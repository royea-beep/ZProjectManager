...
1. **Wingman** — In App Store Connect: open build 1.0.0 (5) in TestFlight → complete Export compliance → add internal testers → install from TestFlight app and confirm login screen appears within ~8s. In ZPM, set Wingman’s Next Action to: *TestFlight build 5 — add testers & smoke-test*.
