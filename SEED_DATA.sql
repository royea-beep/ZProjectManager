...
('9soccer', 'Football clip quiz — watch 10s clip, answer questions, 5 levels, leaderboard. Next.js + Capacitor iOS/Android.', 'mobile-app', 'development', 'building', 'high', 'Ship to TestFlight and Google Play internal; grow daily challenge + Facebook auto-post', '["Next.js 16","Capacitor","Supabase","Tailwind","TypeScript"]', 'C:\Projects\9soccer', 1, NULL, 'CI secrets for iOS/Android; ensure static export to out/ for Capacitor', 'Configure GitHub Actions secrets; run content pipeline; add DEPLOY.md', 75, '2026-03-08');
...
((SELECT id FROM projects WHERE name='9soccer'), 'Dev Server', 'npm run dev', 'terminal', 'powershell', 0, 1, '["3000"]'),
((SELECT id FROM projects WHERE name='9soccer'), 'Open in VS Code', 'code C:\Projects\9soccer', 'vscode', 'powershell', 0, 2, NULL),
((SELECT id FROM projects WHERE name='9soccer'), 'Content Pipeline', 'npx tsx agents/pipeline.ts', 'terminal', 'powershell', 0, 3, NULL);
