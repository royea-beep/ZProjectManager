...
| **90soccer** | Building (TestFlight/Play), 90soccer.ftable.co.il | ❓ | No he/i18n found in app yet | **Add he first**: lang context or i18n, default he, RTL |
...
- **Add he + audit:** 90soccer, KeyDrop when deploying; preprompt-web if needed.
...
3. Re-run this audit when new platforms go live (e.g. 90soccer, KeyDrop).
